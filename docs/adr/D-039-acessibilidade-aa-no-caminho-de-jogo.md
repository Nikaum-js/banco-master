...
> ⚠️ **Cláusula revogada pela [D-079](D-079-retrato-de-celular-e-orientacao-servida.md)** (2026-07-31). Retrato de celular passou a ser orientação **servida**, com layout próprio, e o aviso de rotação saiu do caminho de jogo. A conta de geometria abaixo continua correta — o que estava errado era manter o layout de paisagem em retrato e concluir dali que retrato era impossível. **Só esta cláusula caiu**: os quatro compromissos de AA, a exceção de borda e o gate no CI seguem valendo.
