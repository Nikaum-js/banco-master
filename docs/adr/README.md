...
- [D-068](D-068-diretorio-opt-in-de-lobbies-anonimos.md) — Diretório opt-in publica somente metadados mínimos de lobbies anônimos, sem enumerar salas privadas (refina D-019/D-020/D-036/D-042/D-052)
