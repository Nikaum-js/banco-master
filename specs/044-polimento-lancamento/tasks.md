...
- [ ] **T075** `src/game/ui/OrientationGate.tsx`: o aviso de girar hoje dispara em **qualquer** retrato, sem limiar — desvio do [D6 do plan](./plan.md#d6--retrato-é-uma-tela-acima-da-árvore-não-um-layout-alternativo), que previa "retrato **abaixo do limiar**". Do jeito atual, um monitor vertical ou um tablet em retrato (onde a mesa cabe, porque o breakpoint de 1100px já empilha os painéis) recebe "gire o aparelho" sem motivo. Aplicar o limiar: o aviso vale quando a largura é insuficiente para servir a mesa, não quando a orientação é retrato. Cobrir com teste nos dois lados do limiar.
