...
export function ThemeControl() {
  ...
  return (
    <button
      ...
      className="fixed bottom-14 left-3 z-[80] grid h-9 w-9 place-items-center rounded-full bg-coffee-950/70 text-cream shadow-[var(--shadow-lift)] backdrop-blur transition hover:bg-coffee-950/90 hover:text-gold"
    >
